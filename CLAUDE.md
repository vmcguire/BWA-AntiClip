...
> ✅ **This is the CANONICAL home for BWA-AntiClip.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-AntiClip/`. Author here — always.
>
...
Then cut a GitHub Release here (`vmcguire/BWA-AntiClip`) and attach the notarized `BWA-AntiClip.vst3`.
